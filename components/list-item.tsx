...
export default function ListItem({ person, index }: Props) {
  return (
    <li className="flex items-center gap-5 rounded-xl border-b-2 p-2.5 *:animate-pulse first:border-t-0 first:pt-0 last:border-b-0 odd:bg-gray-100 even:bg-orange-100 last:md:pb-0">
